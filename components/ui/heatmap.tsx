...
const daysOfTheWeekLabels = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
...
function daysOfTheWeekIndicator({
    ...
    return daysOfTheWeekLabels.map((day, i) =>
...
export default function Heatmap(props: HeatmapProps) {
    ...
    if (colorMode === "discrete") {
        const {
            ...
            gap: _g,
            displayStyle: _ds,
            valueDisplayFunction: _vdf,
            dateDisplayFunction: _ddf,
            className: _cn,
            colorMode: _cm,
            customColorMap: _ccm,
            colorScale: _csc,
